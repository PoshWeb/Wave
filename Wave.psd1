#
# Module manifest for module 'Wave'
#
...
GUID = '4c742e3d-3dab-4255-acd8-8e9d73eb4e60'
...
TypesToProcess = @('Wave.types.ps1xml')
...
FunctionsToExport = @('Wave', 'Get-Wave')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/PoshWeb/Wave'
